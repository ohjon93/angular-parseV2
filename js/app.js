...
angular.module('ToDoApp', [])
    .config(function($httpProvider) {
        ...
        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = 'YA7hACoYpUoxKy4HN5tur9922tRzlJ3eC5bSUfZc';
        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = 'D1O76porpmVeXI1iPss2fzrflS0prrvHpbPGam0s';
    })
    ...
    .controller('TasksController', function($scope, $http) {
        ...
        $scope.refreshTasks = function() {
            ...
            $http.get('https://api.parse.com/1/classes/tasks' + '?where={"done" : false}')
                .success(function(responseData) {
                    ...
                    //which will contain an array of all the data objects
        ...
        //iniialize a new task object on the scope for the new task form
     ...
     $scope.addTask = function(task) {
        ...
        $http.post('https://api.parse.com/1/classes/tasks', task)
            .success(function(responseData) {
                ...
                //copy that to the task that we just inserted

                task.objectId = responseData.objectId;

                //add that tasks to our task list
